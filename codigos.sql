...
-- continuar na aula 24



----VOLTANDO PRO EXEMPLO LIVRARIA
USE PROJETO;
...
-- 			COMANDO "OU"
--PROJETAR O NOME, SEXO E ENDEREÇO DE CLIENTE QUE
--SÃO HOMENS OU QUE MOREM NO RIO DE JANEIRO
SELECT NOME, SEXO, ENDERECO FROM CLIENTE
WHERE
SEXO = 'M' OR ENDERECO LIKE '%RJ';

--TROCANDO POR "AND"
--TODAS CONDIÇÕES TEM QUE SER ATENDIDAS, SER HOMEM E MORAR NO RJ
SELECT NOME, SEXO, ENDERECO FROM CLIENTE
WHERE
...
/*CONTANDO OS REGISTROS DE UMA TABLEA*/
SELECT COUNT(*) FROM CLIENTE;--IMPRIME A QUANTIDADE MAS COM O NOME DA FUNÇÃO COUNT(*)
...
SELECT SEXO, COUNT(*) AS 
FROM CLIENTE
GROUP BY SEXO;

SELECT SEXO, COUNT(*) AS "QUANTIDADE"-- USANDO ALIAS
FROM CLIENTE
GROUP BY SEXO;

----EXERCICIOS DE PERFORMANCE DE BD----

--EXERCIICOS

--1 Traga os funcionarios que trabalhem no departamento
-- de filmes OU no departamento de roupas

--2 O gesto de marketing pediu a lista das funcionárias
-- que trabalhem no departamento de filmes ou no
-- departamento lar. Ele necessita enviar um email
-- para as colaboradoras desses dois setores

-- 3 Traga os funcionarios do sexo masculinio
...
--EXERCIICOS
--== NÃO ESQUECA QUE O "OU" A MAIORIA  DEVE VIR PRIMEIRO - PQ SE A PRIMEIRA OPCAO FOR VERDADEIRA E NEM VAI NA OUTRA COLUNA

--== E O "AND" VEM DEPOIS, A MAIORIA DEVE VIR DEPOIS PARA PERFORMANCE
...
-- COLOCAMOS NA PRIMEIRA CONDICAO QUEM TEM MAIOR CHANCES DE UMA
-- SAíDA VERDADEIRA, POIS A SEGUNDA NAO SERÁ CHECHADA
...
WHERE NOME = 'CARLA';
-- FIM DA CLÁUSULA UPDATE


-- PARA VOLTAR, USAR COMMIT E ROLLBACK
...
--TAMBÉM É POSSIVEL USAR COMANDO DE PROJEÇÃO PARA REALIZAR CONTAS
SELECT 6 - 1;
...
-- ANTES DE DELETAR, PROJETE PARA TER A CERTEZA. SUBSTTUE DELETE POR SELECT
DELETE FROM CLIENTE
WHERE NOME = 'CARLA'
...
FROM CLIENTE
GROUP BY SEXO;
--A saída está errada porque existe duas carlas
...
-- NATURAL É USAR UM ATRIBUTO QUE É SÓ SEU E USAR COMO CHAVE PRIMÁRIA
-- ARTIFICAL E USAR UM ID

-- NÃO É RECOMENDADO USAR UMA CHAVE NATURAL COMO CHAVE PRIMARIA PORQUE SE ALGO MUDAR NO BANCO, SUA EMPRESA JÁ ERA
...
QUE VAI ATÉ OUTRO TABELA PARA FAZER REFERENCIA ENTRE REGISTROS*/
...
INSERT INTO CLIENTE VALUES(NULL, 'CARLOS','M','CARLOS@IG.COM','2453421');
INSERT INTO CLIENTE VALUES(NULL, 'ANA','F','ANA@IG.COM','453246352');
INSERT INTO CLIENTE VALUES(NULL, 'CLARA','F',NULL,'348645234');
INSERT INTO CLIENTE VALUES(NULL, 'JORGE','M','JORGE@IG.COM','3459438');
INSERT INTO CLIENTE VALUES(NULL, 'CELIA','F','JCELIA@IG.COM','345645345');
...
|         2 | CARLOS | M    | CARLOS@IG.COM | 2453421     |
|         3 | ANA    | F    | ANA@IG.COM    | 453246352   |
|         4 | CLARA  | F    | NULL          | 348645234   |
|         5 | JORGE  | M    | JORGE@IG.COM  | 3459438     |
|         6 | CELIA  | F    | JCELIA@IG.COM | 345645345   |
+-----------+--------+------+---------------+-------------+
...
--CONTINUAR NA AULA 44
SELECT * FROM ENDERECO;

DESC TELEFONE;

INSERT INTO TELEFONE VALUES(NULL, 'CEL', '75136955', 5);
INSERT INTO TELEFONE VALUES(NULL, 'RES', '45812300', 6);
INSERT INTO TELEFONE VALUES(NULL, 'COM', '98754122', 4);
INSERT INTO TELEFONE VALUES(NULL, 'COM', '65897455', 2);
INSERT INTO TELEFONE VALUES(NULL, 'CEL', '96587124', 1);
INSERT INTO TELEFONE VALUES(NULL, 'CEL', '93587451', 3);
INSERT INTO TELEFONE VALUES(NULL, 'COM', '96587412', 5);
INSERT INTO TELEFONE VALUES(NULL, 'RES', '96587456', 3);
INSERT INTO TELEFONE VALUES(NULL, 'CEL', '96541025', 4);


SELECT COUNT(*) AS "NUMERO DE CLIENTES" FROM CLIENTE;


/*SELECAO, PROJEÇAO E JUNLÇAO*/
...
/*SELEÇÃO É UMA FILTRAGEM DE UM SUBCONJUNTO(TABELA)*/
--SELEÇÃO É UM SUBCONJUNTO  DO CONJUNTO TOTAL DE REGISTROS DE UMA TABELA
--CLAUSULA DE SELEÇÃO É O WHERE
...
+--------+------+----------+----------------+------+----------+
| JORGE  | M    | CENTRO   | VITORIA        | CEL  | 75136955 |
| CELIA  | F    | FLAMENGO | RIO DE JANEIRO | RES  | 45812300 |
| CLARA  | F    | CENTRO   | B. HORIZONTE   | COM  | 98754122 |
| CARLOS | M    | ESTACIO  | RIO DE JANEIRO | COM  | 65897455 |
| JOAO   | M    | CENTRO   | RIO DE JANEIRO | CEL  | 96587124 |
| ANA    | F    | JARDINS  | SAO PAULO      | CEL  | 93587451 |
| JORGE  | M    | CENTRO   | VITORIA        | COM  | 96587412 |
| ANA    | F    | JARDINS  | SAO PAULO      | RES  | 96587456 |
| CLARA  | F    | CENTRO   | B. HORIZONTE   | CEL  | 96541025 |
+--------+------+----------+----------------+------+----------+
9 rows in set (0.01 sec)


---OUTR FORMA DE FAZER JOIN EM MAIS DE 2 TABLEAS
--- TRABALHANDO COM PONTEIRAMENTO
...
INSERT INTO CLIENTE VALUES(NULL, 'PAULA', 'M', NULL, '77455155');
...
--ATUALIZANDO REGISTROS DE MANEIRA PROFISSIONAL
...
/* ADICIONANDO UMA COLUNA EM NA ORDEM ESPECÍFICA */
ALTER TABLE PRODUTO
ADD COLUMN PESO FLOAT(10,2) NOT NULL
AFTER NOME_PRODUTO;
...
SELECT CLIENTE.IDCLIENTE, CLIENTE.NOME, CLIENTE.SEXO, CLIENTE.EMAIL, CLIENTE.CPF, 
        TELEFONE.IDTELEFONE, TELEFONE.TIPO, TELEFONE.NUMERO, TELEFONE.ID_CLIENTE, 
        ENDERECO.IDENDERECO, ENDERECO.RUA, ENDERECO.BAIRRO, ENDERECO.CIDADE, ENDERECO.ESTADO, ENDERECO.ID_CLIENTE
FROM CLIENTE
INNER JOIN TELEFONE
ON CLIENTE.IDCLIENTE = TELEFONE.ID_CLIENTE
INNER JOIN ENDERECO
...
WHERE SEXO = 'F';
 ...
 SELECT * FROM CLIENTE
 WHERE IDCLIENTE IN (6,12,13,18,16);
...
/* IDS E EMAIL DAS MULHERES QUE MOREN NO CENTRO DO RIO DE JANEIRO E
NÃO TENHAM CELULAR  */
...
| CLARA   | NULL              | MG     | 98754122 |
| CLARA   | NULL              | MG     | 96541025 |
| JOAO    | JOAOA@IG.COM      | RJ     | 96587124 |
| ANA     | ANA@IG.COM        | SP     | 93587451 |
| ANA     | ANA@IG.COM        | SP     | 96587456 |
| CARLOS  | CARLOSA@IG.COM    | RJ     | 65897455 |
| CELIA   | JCELIA@IG.COM     | RJ     | 45812300 |
| JORGE   | JORGE@IG.COM      | ES     | 75136955 |
| JORGE   | JORGE@IG.COM      | ES     | 96587412 |
+---------+-------------------+--------+----------+
...
| ADRIANA | ADRIANA@GMAIL.COM | RJ     | 44522578 |
| JOICE   | JOICE@GMAIL.COM   | RJ     | 44522578 |
| CLARA   | NÃO TEM EMAIL     | MG     | 98754122 |
| CLARA   | NÃO TEM EMAIL     | MG     | 96541025 |
| JOAO    | JOAOA@IG.COM      | RJ     | 96587124 |
| ANA     | ANA@IG.COM        | SP     | 93587451 |
| ANA     | ANA@IG.COM        | SP     | 96587456 |
| CARLOS  | CARLOSA@IG.COM    | RJ     | 65897455 |
