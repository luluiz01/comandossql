...
--COMO ESTAMOS TRABALHANDO COM OR EA SEGUNDA CONDICAO É OPCIONAL
-- COLOCAMOS NA PRIMEIRA CONDICAO QUEM TEM MAIOR CHANCES DE UMA
-- SAUDA VERDADEIRA, POIS A SEGUNDA NAO SERÁ CHECHADA
...
SELECT * FROM FUNCIONARIOS
WHERE
SEXO = 'MASCULINO' OR DEPARTAMENTO LIKE 'JARDIM;'
