...
SELECT CLIENTE.IDCLIENTE, CLIENTE.NOME, CLIENTE.SEXO, CLIENTE.EMAIL, CLIENTE.CPF, TELEFONE.IDTELEFONE, TELEFONE.TIPO, TELEFONE.NUMERO, TELEFONE.ID_CLIENTE, ENDERECO.IDENDERECO, ENDERECO.RUA, ENDERECO.BAIRRO, ENDERECO.CIDADE, ENDERECO.ESTADO, ENDERECO.ID_CLIENTE
FROM CLIENTE
INNER JOIN TELEFONE
ON CLIENTE.IDCLIENTE = TELEFONE.ID_CLIENTE
INNER JOIN ENDERECO
...
SELECT CLIENTE.IDCLIENTE, CLIENTE.EMAIL, ENDERECO.ESTADO
FROM CLIENTE
INNER JOIN ENDERECO
ON IDCLIENTE = ID_CLIENTE
WHERE SEXO = 'F';
